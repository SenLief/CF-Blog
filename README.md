...
- 首页、文章详情、独立关于页、归档、标签、系列与上一篇/下一篇导航
...
- 标签、系列分组与排序、站点导航、社交链接、主题色和 SEO 设置
- 批量发布、转为草稿、归档与删除；破坏性操作带确认或版本校验

### 媒体素材库

- 图片上传至 R2，元数据保存在 D1，可设置替代文本并直接插入 Markdown
...
- D1 保存文章与版本，R2 只保存图片，媒体通过公开 Blog Worker 输出
...
测试覆盖共享契约、文章版本与状态变更、MCP 工具、媒体操作、视频 URL 规范化、安全 Markdown 渲染和光标插入逻辑。
